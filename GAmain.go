...
// 	//Birgham
// 	// err := d.Init([]float64{0.0, 0.0, 1500.0, 0.0, 0.0, 0.0, 0.0}, []float64{3000.0, 2000.0, 3000.0, 3000.0, 360.0, 6.3, 10.0}) //Creating the grid for possible answers
...
func main() {
	...
	//Birgham
	err := d.Init([]float64{0.0, 0.0, 1500.0, 0.0, 0.0}, []float64{3500.0, 3500.0, 3000.0, 3000.0, 360.0}) //Creating the grid for possible answers
